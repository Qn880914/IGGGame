...
{
    public static string blackListFilePath = ToLuaSetting.injectionFilesPath + "InjectionBlackList.txt";
    ...
    void InitPathsInfo()
    {
        ...
        {
            pathsInfoSavedPath = ToLuaSetting.injectionFilesPath + "LuaInjectionSkipPaths.txt";
        }
        if (paths != null)
        {
            return;
        ...
        else
        {
            ...
            string toluaPath = GetRelativePath(ToLuaSetting.injectionFilesPath.Substring(0, ToLuaSetting.injectionFilesPath.Length - "Injection/".Length));
            ...
            paths.Add(ToLuaSetting.toluaBaseType);
            paths.Add(GetRelativePath(ToLuaSetting.saveDir));
        }
    }
