...
public class CreatePlane : ScriptableWizard {
    ...
    void OnWizardCreate() {
        ...
        Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath("Assets/Editor/Geometry" + planeAssetName, typeof(Mesh));
        ...
        if (m == null) {
            ...
            AssetDatabase.CreateAsset(m, "Assets/Editor/Geometry" + planeAssetName);
