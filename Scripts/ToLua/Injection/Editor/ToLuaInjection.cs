...
#region NormalMethod
    ...
    static void ExportInjectionPublishInfo(SortedDictionary<string, List<InjectedMethodInfo>> data)
    {
        ...
        File.WriteAllText(ToLuaSetting.baseLuaDir + "System/Injection/InjectionBridgeInfo.lua", StringBuilderCache.GetStringAndRelease(sb));
    }
    ...
    {
        string incrementalFilePath = ToLuaSetting.injectionFilesPath + "InjectionBridgeEditorInfo.xml";
